...
weibofile = open('weiboAll.txt', 'r', encoding='utf-8')
...
if __name__ == '__main__':
    ...
    start = 1021
    count = 0
    # commentfile = open('./commentfile_' + str(count) + '.csv', 'a', encoding='utf-8')
    commentfile = open('./commentfile_all.csv', 'a', encoding='utf-8')
